...
COMMENT ON TABLE ACT_ID_GROUP IS '用户组信息';
COMMENT ON COLUMN ACT_ID_GROUP.ID_ IS '组名';
COMMENT ON COLUMN ACT_ID_GROUP.REV_ IS '版本号';
COMMENT ON COLUMN ACT_ID_GROUP.NAME_ IS '用户组描述信息';
...
COMMENT ON TABLE ACT_ID_USER IS '用户信息';
