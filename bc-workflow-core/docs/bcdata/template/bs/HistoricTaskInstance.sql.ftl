with t (task_id, task_name, task_status, start_time, end_time, duration, due_date, process_id, process_name
  ...
  select t.id_ task_id, t.name_ task_name
    ...
    , a.code assignee_code, a.name assignee, e.suspension_state_ pstatus, t.task_def_key_, pd.key_ process_key
    , pi.info->>'wf_code' wf_code,pi.info->>'subject' wf_subject, pd.deployment_id_
