 ...
 * @author dragon
 */
public class WorkspaceServiceImpl_old implements WorkspaceService_old {
	...
	public Map<String, Object> findWorkspaceInfo(String processInstanceId) {
		...
		if (instance.getEndTime() == null) {
			...
			flowStatus = WorkspaceServiceImpl_old.COMPLETE;// 已结束
		}
	...
	private Map<String, Object> buildWSDoneInfo(int flowStatus,
		...
		for (HistoricTaskInstance task : tasks) {
			...
			// -- 意见、附件信息
			buildFlowAttachsInfo(WorkspaceServiceImpl_old.COMPLETE, items,
					this.findTaskFlowAttachs(task.getId(), allFlowAttachs));
